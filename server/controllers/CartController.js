      ...
      for (const cartItem of user.cart) {
        ...
        if (product) {
          const cartItemWithDetails = {
            ...
            price: product.price,
            sizeAndQuantitySizeWant: Object.entries(cartItem.sizes).map(([sizeName, quantity]) => ({
              sizeName,
              quantity,
            })),
            totalBill: 0,
          ...
          const productTotal = cartItemWithDetails.sizeAndQuantitySizeWant.reduce((total, sizeQuantity) => {
            const quantity = parseInt(sizeQuantity.quantity);
            const price = parseFloat(cartItemWithDetails.price);
